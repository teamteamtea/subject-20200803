  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <!--   <div class="text-right"><a href="/BoardMain.jsp" class="pull-right"><span class="pull-right"><button class="btn btn-primary pull-right" >목록보기</button></span></a></div> -->
    ...
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" placeholder="검색하세요." aria-label="Search">
				 ...
				 <table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>${board.btext }</td>
							<td>${board.bdate }</td>
							<td><a href="modify.jsp" name="update"><button class="btn btn-primary" >수정</button></a></td>
							<td><a href="${pageContext.request.contextPath }/deletes"><button class="btn btn-danger">삭제</button></a></td>
						</tr>
					</c:forEach>
